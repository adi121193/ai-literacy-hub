...
const roles = [
  {
    ...
    bundles: [
      { type: "Chatbot", name: "Strategy Q&A" },
      { type: "Course", name: "AI for Leaders" },
      { type: "Workshop", name: "Leadership Lab" },
    ],
    link: "#leaders",
  },
  {
    ...
    bundles: [
      { type: "Chatbot", name: "Policy Assistant" },
      { type: "Course", name: "Managing AI Teams" },
      { type: "Workshop", name: "Manager Bootcamp" },
    ],
    link: "#managers",
  },
  {
    ...
    bundles: [
      { type: "Chatbot", name: "Tech Support" },
      { type: "Course", name: "AI Engineering" },
      { type: "Workshop", name: "Technical Deep Dive" },
    ],
    link: "#technical",
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {roles.map((role) => {
            ...
            return (
              <div
                key={role.title}
                className="group bg-card rounded-2xl p-8 border border-border hover:border-primary transition-smooth hover:shadow-lg"
              >
                {/* Label Pill */}
