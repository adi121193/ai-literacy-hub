...
const courses = [
  {
    ...
    outcomes: [
      "Understand AI risks and principles",
      "Recognize high-risk AI use cases",
      "Apply RAI frameworks to real scenarios",
    ],
  },
  {
    ...
    outcomes: [
      "Navigate ISO 42001 requirements",
...
const CoursesWorkshops = () => {
  return (
    <section id="learning" className="py-20 md:py-32 bg-soft-gray">
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {courses.map((course, index) => (
              <div
                key={index}
                className="bg-card rounded-2xl p-6 border border-border hover:border-primary transition-smooth hover:shadow-lg"
              >
                {/* Tag */}
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 pt-2">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      ...
                      <span>Format: {workshop.format}</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
